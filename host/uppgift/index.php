...
<body>
    ...
    <?php
    $dbh = new PDO("mysql:host=localhost;dbname=news;charset=utf8" , "username" , "password");
       $find = $_POST['find'];
    
   $query = $db->prepare('SELECT * FROM news WHERE userid() AND content(now(), INTERVAL 2 MONTH) AND title LIKE :like ORDER BY title');
